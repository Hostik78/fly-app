  ...
  plugins: [
    ...
    VitePWA({
      ...
      injectManifest: {
        ...
        // PNG включает обе тематические картинки живой заставки. После первого
        // открытия они сохраняются на телефоне и при следующих запусках видны
        // сразу, ещё до загрузки данных ленты.
