  ...
  plugins: [
    ...
    VitePWA({
      ...
      injectManifest: {
        ...
        // jpg - только картинка-заглушка экрана загрузки (см. LoadingScreen.tsx,
        // loading-screen-poster.jpg) - маленькая (около 14 КБ), не раздувает кеш,
        // зато видна мгновенно (из уже сохранённого на телефоне) начиная со
        // второго открытия, а не только с первого.
