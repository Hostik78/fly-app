...
export interface Profile {
  ...
  lastSeenAt?: string // когда человек последний раз пользовался приложением (ISO-строка) -
                       // заполняется только там, где реально нужно (см. useMatches.ts),
                       // для "был в сети N назад" в шапке чата
}
